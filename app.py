...
Sistema de Automação e Monitoramento para Gestão Escolar

Author: Renan Bezerra
Version: 2.0.0 - Vercel Production
...
# Database path for Vercel (ephemeral filesystem)
# In production, use environment variables or external DB
...
@role_required(['goe'])
def usuarios():
    """Gerenciamento de usuários (apenas GOE)"""
    conn = get_db_connection()
    cursor = conn.cursor()
...
if __name__ == '__main__':
    print("=" * 60)
    print("🚀 Automação Diária - Escolas Públicas")
    print("=" * 60)
    print("Desenvolvido por: Renan Bezerra")
